...
do concurrent (kx1=1:M/2,ky1=-M/2:M/2,kx2=-M/2:M/2,ky2=-M/2:M/2,&
            ((kx2 .ge. -kx1) .and. (kx2 .le. M/2-kx1) .and. (ky2 .ge. -M/2-ky1) .and. (ky2 .le. M/2-ky1)))
    nl(kx1+kx2,ky1+ky2) = nl(kx1+kx2,ky1+ky2) + &
                    omega_hat_c(kx1,ky1)*omega_hat_c(kx2,ky2)*beta(kx1,ky1,kx2,ky2) 
end do
do concurrent (kx1=-M/2:-1,ky1=-M/2:M/2,kx2=-M/2:M/2,ky2=-M/2:M/2,&
             ((kx2 .ge. -kx1) .and. (kx2 .le. M/2-kx1) .and. (ky2 .ge. -M/2-ky1) .and. (ky2 .le. M/2-ky1)) )
    nl(kx1+kx2,ky1+ky2) = nl(kx1+kx2,ky1+ky2) + &
                    omega_hat_c(kx1,ky1)*omega_hat_c(kx2,ky2)*beta(kx1,ky1,kx2,ky2) 
end do
kx1=0
do concurrent (ky1=-M/2:-1,kx2=-kx1:min(M/2-kx1,M/2),ky2=-M/2:M/2,&
              ((ky2 .ge. -M/2-ky1) .and. (ky2 .le. M/2-ky1)) )
    nl(kx1+kx2,ky1+ky2) = nl(kx1+kx2,ky1+ky2) + &
                    omega_hat_c(kx1,ky1)*omega_hat_c(kx2,ky2)*beta(kx1,ky1,kx2,ky2) 
end do
kx1=0
do concurrent (ky1=1:M/2,kx2=-kx1:min(M/2-kx1,M/2),ky2=-M/2:M/2,&
             ((ky2 .ge. -M/2-ky1) .and. (ky2 .le. M/2-ky1)) )
    nl(kx1+kx2,ky1+ky2) = nl(kx1+kx2,ky1+ky2) + &
                    omega_hat_c(kx1,ky1)*omega_hat_c(kx2,ky2)*beta(kx1,ky1,kx2,ky2) 
end do
